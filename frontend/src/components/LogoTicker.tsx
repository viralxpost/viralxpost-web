...
const LogoTicker = () => {
  return (
    <div className=" text-white py-[72px]">
      <div className="container ">
        ...
        <div className=" flex overflow-hidden before:content-[''] before:z-10 after:content-[''] before:absolute after:absolute before:h-full after:h-full before:w-5 after:w-5 relative  after:right-0 before:left-0 before:top-0 after:top-0 before:bg-[linear-gradient(to_right,#000,rgb(0,0,0,0))] after:bg-[linear-gradient(to_left,#000,rgb(0,0,0,0))]">
          <motion.div
            ...
            animate={{ translateX: '-50%' }} className="flex gap-16 flex-none pr-16">

            {
              images.map(image => (
                <img src={image.src} key={image.alt} alt={image.alt} className="flex-none h-8 w-auto" />
              ))
            }
