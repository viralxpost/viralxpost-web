...
const pricingTiers = [
    ...
    },
    {
        ...
        features: [
            ...
            "No support or assistance",
            "No API access",
            "No Advance information","No support or assistance",
        ]
    }
]
                    ...
                    {pricingTiers.map(({ title,
                        ...
                        <div key={title} className={twMerge("card", inverse && 'border-black bg-black text-white')}>
                            <div className="flex justify-between">
                                ...
                                {popular && (
                                <div className="inline-flex text-sm px-4 py-1.5 rounded-xl border border-white/20"><motion.span
                                animate={{
                                ...
                                className="bg-[linear-gradient(to_right,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF)] [background-size:200%] text-transparent bg-clip-text font-medium">Popular</motion.span></div>
                                )}
                            </div>
                            ...
                            <ul className="flex flex-col gap-5 mt-8">
                                {
                                    features.map((feature, index) => (
                                        <li className="text-sm flex items-center gap-4" key={index}><Check className="h-6 w-6" /><span>{feature}</span></li>
                                    ))
                                }
                            </ul>
                        </div>
